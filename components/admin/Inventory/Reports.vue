...
<template>
  <div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          ...
          <p class="text-sm text-gray-600 dark:text-gray-400">{{ reportType.description }}</p>
        </button>
      </div>

      <!-- Date Range Filter (for movements summary) -->
      <div v-if="selectedReportType === 'movements-summary'" class="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
        <div>
    ...
    <div v-else-if="reportData" class="space-y-6">
      <!-- Stock Levels Report -->
      <div v-if="selectedReportType === 'stock-levels'" class="space-y-6">
        <!-- Summary Cards -->
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
            ...
            <div class="text-sm text-gray-600 dark:text-gray-400">Medium Stock</div>
          </div>
          <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
            <div class="text-2xl font-bold text-green-600 dark:text-green-400">
              {{ reportData.summary.highStock }}
            </div>
            <div class="text-sm text-gray-600 dark:text-gray-400">High Stock</div>
          </div>
        </div>
      ...
      <div v-if="selectedReportType === 'movements-summary'" class="space-y-6">
        <!-- Summary Cards -->
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
            <div class="text-2xl font-bold text-gray-900 dark:text-white">
          ...
          <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
            ...
            <div class="text-sm text-gray-600 dark:text-gray-400">Net Change</div>
          </div>
        </div>
      ...
      <!-- Low Stock Report -->
      <div v-if="selectedReportType === 'low-stock'" class="space-y-6">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
      ...
      <div v-if="selectedReportType === 'reorder-alerts'" class="space-y-6">
        <!-- Priority Summary -->
