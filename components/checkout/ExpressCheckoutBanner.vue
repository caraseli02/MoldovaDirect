<template>
  <div
    v-if="showBanner"
    class="express-checkout-banner mb-6 p-6 bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-lg border border-indigo-200 dark:border-indigo-700"
  >
    <!-- Auto-skip countdown section -->
    <div
      v-if="isCountingDown"
      class="mb-4 p-4 bg-white dark:bg-gray-800 rounded-lg border-2 border-indigo-500 dark:border-indigo-400"
    >
      <div class="flex items-center justify-between mb-3">
        <div class="flex items-center space-x-2">
          <svg
            class="w-5 h-5 text-indigo-600 dark:text-indigo-400 animate-pulse"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
