    ...
    <div class="container">
      ...
      >
        <button
          ...
          :class="[
            'rounded-full px-6 py-2 text-sm font-semibold transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-gray-950 touch-manipulation cursor-pointer relative z-10 min-h-[44px] flex items-center',
