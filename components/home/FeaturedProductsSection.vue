    ...
    <div class="container">
      ...
      >
        <UiButton
          ...
          :class="[
            'rounded-full px-6 py-2 text-sm font-semibold transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-gray-950',
      ...
      <div v-else-if="filteredProducts.length">
        ...
        <div
          id="products-panel"
          role="tabpanel"
          class="mt-12 hidden gap-6 md:grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4"
        >
          <ProductCard
            v-for="product in filteredProducts"
            :key="product.id"
