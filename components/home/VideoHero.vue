<template>
  <section class="relative flex items-start md:items-center overflow-hidden bg-brand-dark">
    ...
    <div class="hero-container relative flex w-full items-start md:items-center min-h-[80vh] md:min-h-[75vh]"
      ...
      <div class="container relative z-10 mx-auto px-4 pt-36 pb-12 md:py-24 lg:py-32">
        <div v-motion :initial="{ opacity: 0, y: 30 }" :enter="{
          ...
          <div v-if="badge" v-motion :initial="{ opacity: 0, scale: 0.9 }"
          ...
          <p v-if="subtitle" v-motion :initial="{ opacity: 0, y: 20 }"
          ...
          <div v-if="highlights && highlights.length > 0" v-motion :initial="{ opacity: 0, y: 20 }"
            ...
            <div v-for="(highlight, index) in highlights" :key="highlight.label" v-motion
              ...
              :visible-once="{ opacity: 1, scale: 1, transition: { delay: 700 + index * 100 } }" class="text-center">
      ...
      <div v-motion :initial="{ opacity: 0, y: -10 }" :enter="{ opacity: 1, y: 0, transition: { delay: 1000 } }"
