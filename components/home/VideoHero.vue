    ...
    >
      ...
      <div class="container relative z-10 mx-auto px-4 pt-36 pb-12 md:py-24 lg:py-32">
        ...
        >
          ...
          >
            ...
            >
              <div
                class="mb-1 text-2xl font-bold tracking-tight text-brand-light md:mb-2 md:text-4xl"
                style="text-shadow: 0 2px 10px rgba(0,0,0,0.75)"
              >
                {{ highlight.value }}
              </div>
              <div
                class="text-xs font-medium uppercase tracking-[0.1em] text-brand-light/75 md:text-sm"
      ...
      >
        <commonIcon
          ...
          class="h-6 w-6 text-brand-light/40"
        />
      </div>
    </div>
  </section>
