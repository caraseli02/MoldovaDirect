      ...
      <div class="mt-12 grid gap-8 lg:grid-cols-2 lg:gap-12">
        ...
        >
          <div class="sticky top-24 rounded-2xl bg-slate-50 p-8 shadow-lg">
            ...
            <div v-if="loading" class="flex h-96 items-center justify-center">
              <commonIcon name="lucide:loader-2" class="h-8 w-8 animate-spin text-primary-600" />
            </div>
        ...
        >
          <div
            ...
            :key="region.id"
            class="group rounded-2xl border-2 border-slate-200 bg-white p-6 shadow-sm transition-all hover:border-primary-300 hover:shadow-lg"
            :class="{ 'border-primary-500 shadow-lg': selectedRegion === region.id }"
          >
            <!-- Region Header -->
