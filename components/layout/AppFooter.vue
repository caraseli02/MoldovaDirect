    ...
    <div class="container py-12">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div class="mt-6">
            <p class="text-xs text-gray-500 mb-3">{{ $t('footer.trust.title') }}</p>
            <div class="flex flex-wrap gap-3">
              ...
              <div class="flex items-center gap-2 bg-gray-800 px-3 py-2 rounded-lg">
                ...
                <span class="text-xs text-gray-300">SSL Secure</span>
              </div>
              ...
              <div class="flex items-center gap-2 bg-gray-800 px-3 py-2 rounded-lg">
                ...
                <span class="text-xs text-gray-300">Secure Payment</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="mt-12 pt-8 border-t border-gray-800">
        <div class="flex flex-col md:flex-row items-center justify-between gap-4">
          <div class="text-center md:text-left">
            <p class="text-xs text-gray-500 mb-2">{{ $t('footer.payment.title') }}</p>
