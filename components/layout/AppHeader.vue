<template>
  <header class="bg-white dark:bg-slate-800 shadow-sm dark:shadow-slate-900/20 sticky top-0 z-50 transition-colors duration-300">
    <div class="container">
      <div class="flex items-center justify-between h-16">
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:flex items-center space-x-4">
            ...
            <!-- Search -->
            <button class="p-2 text-gray-700 dark:text-slate-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
            ...
            >
              ...
              <!-- Cart count badge -->
              <span v-if="cartItemsCount > 0" class="absolute -top-1 -right-1 bg-primary-600 dark:bg-primary-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">
                {{ cartItemsCount }}
              </span>
            </NuxtLink>
          </div>
          ...
          <div class="flex md:hidden items-center space-x-4">
            ...
            >
              ...
              <!-- Cart count badge -->
              <span v-if="cartItemsCount > 0" class="absolute -top-1 -right-1 bg-primary-600 dark:bg-primary-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center font-semibold">
                {{ cartItemsCount }}
              </span>
            </NuxtLink>
            ...
            >
              ...
              <div class="w-6 h-6 flex flex-col justify-center items-center">
                <span 
                  ...
                  :class="mobileMenuOpen ? 'rotate-45 translate-y-1' : '-translate-y-1'"
                ></span>
                <span 
                  class="block w-6 h-0.5 bg-current transition-all duration-300 ease-in-out"
