  ...
  <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div>
        ...
        <div v-if="shippingAddress" class="text-sm text-gray-600 dark:text-gray-400 space-y-1">
          <p class="font-medium text-gray-900 dark:text-white">{{ shippingAddress.street }}</p>
          <p>{{ shippingAddress.city }}, {{ shippingAddress.postalCode }}</p>
          <p v-if="shippingAddress.province">{{ shippingAddress.province }}</p>
          <p class="font-medium">{{ shippingAddress.country }}</p>
        </div>
      ...
      <div>
        ...
        <div v-if="billingAddress" class="text-sm text-gray-600 dark:text-gray-400 space-y-1">
          <p class="font-medium text-gray-900 dark:text-white">{{ billingAddress.street }}</p>
          <p>{{ billingAddress.city }}, {{ billingAddress.postalCode }}</p>
          <p v-if="billingAddress.province">{{ billingAddress.province }}</p>
          <p class="font-medium">{{ billingAddress.country }}</p>
        </div>
        <p v-else class="text-sm text-gray-500 dark:text-gray-400">No billing address available</p>
      </div>
    </div>
  </div>
</template>
