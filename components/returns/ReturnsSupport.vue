  ...
  <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
    ...
    <div class="mt-4 space-y-3">
      ...
      <NuxtLink
        ...
        class="flex items-center justify-between rounded-lg bg-slate-50 p-3 text-sm font-semibold text-slate-800 ring-1 ring-primary-100 transition hover:bg-slate-100 hover:ring-primary-200 dark:bg-slate-900/20 dark:text-slate-100 dark:ring-primary-800/40 dark:hover:bg-slate-900/30"
