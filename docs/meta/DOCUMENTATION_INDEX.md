...
| Document | Purpose | Last Updated |
|----------|---------|--------------|
| [Test Coverage Analysis](../testing/TEST_COVERAGE_ANALYSIS.md) | Test coverage analysis | Oct 2025 |
| [Test Coverage Implementation](../testing/TEST_COVERAGE_IMPLEMENTATION.md) | Visual test implementation | Oct 2025 |
| [Testing Strategy](../guides/TESTING_STRATEGY.md) | Overall testing approach | - |
| [Auth Testing Guide](../../tests/AUTH_TESTING_GUIDE.md) | Authentication testing | - |
...
| Document | Purpose | Last Updated |
|----------|---------|--------------|
| [Authentication Architecture](../architecture/AUTHENTICATION_ARCHITECTURE.md) | Auth system architecture | Sep 2025 |
| [Cart System Architecture](../architecture/CART_SYSTEM_ARCHITECTURE.md) | Cart system design | Sep 2025 |
| [Cart Analytics](../features/cart/CART_ANALYTICS.md) | Cart analytics system | Sep 2025 |
| [Checkout Flow](../architecture/CHECKOUT_FLOW.md) | Checkout process | Oct 2025 |
| [shadcn Migration](../development/SHADCN_MIGRATION.md) | UI component migration | Aug 2025 |
...
| [Admin Testing](../guides/ADMIN_TESTING.md) | Admin testing dashboard | - |
| [Test User Simulation](../guides/TEST_USER_SIMULATION.md) | Test user personas | - |
| [MFA Implementation](../features/authentication/MFA_IMPLEMENTATION.md) | MFA setup guide | - |
| [Email Logging](../../server/utils/emailLogging.README.md) | Email logging system | - |
| [Email Retry Service](../../server/utils/emailRetryService.README.md) | Email retry service | - |
| [Order Emails](../../server/utils/orderEmails.README.md) | Order email system | - |

### 9. Component & UI Documentation

| Document | Purpose | Last Updated |
|----------|---------|--------------|
| [Component Inventory](../development/component-inventory.md) | Component catalog | - |
| [Component Modernization Plan](../development/component-modernization-plan.md) | UI modernization | - |
| [Troubleshooting Components](../development/troubleshooting-components.md) | Component issues | - |
| [UI/UX Review](../development/ui-ux-review.md) | UX review | - |
| [Components README](../../components/README.md) | Component overview | Nov 2025 |
...
| Document | Purpose | Last Updated |
|----------|---------|--------------|
| [GDPR Compliance](../security/GDPR_COMPLIANCE.md) | Data protection | Nov 2025 |
...
### For QA/Testing
1. [Test Coverage Analysis](../testing/TEST_COVERAGE_ANALYSIS.md)
2. [Test Coverage Implementation](../testing/TEST_COVERAGE_IMPLEMENTATION.md)
...
### For Architects
1. [Authentication Architecture](../architecture/AUTHENTICATION_ARCHITECTURE.md)
2. [Cart System Architecture](../architecture/CART_SYSTEM_ARCHITECTURE.md)
3. [Checkout Flow](../architecture/CHECKOUT_FLOW.md)
4. [Code Review 2025](../analysis/CODE_REVIEW_2025.md)
...
- [Authentication Translations](../features/authentication/authentication-translations.md)
- [Check Translations Script](../../scripts/check-translations.js)
...
See [Archival Policy](./ARCHIVAL_POLICY.md) for guidelines on when and how to archive documentation.

## 📦 Archived Documentation

For historical documentation that is no longer actively maintained, see:
- **[Archive Index](../archive/README.md)** - Archive index and access guide
- **[Archival Policy](./ARCHIVAL_POLICY.md)** - Archival guidelines and process
...
### Technical Questions?
- Review [Code Review 2025](../analysis/CODE_REVIEW_2025.md)
- Check [Quick Start Guide](../getting-started/QUICK_START_GUIDE.md) troubleshooting
