 ...
 * ================================
 * This config uses a layered approach with the @nuxt/eslint module:
 ...
 * 4. eslint-plugin-oxlint: Disables ESLint rules already covered by oxlint
 *
 * HOW IT WORKS WITH NUXT:
 * - withNuxt() from './.nuxt/eslint.config.mjs' is generated by @nuxt/eslint module
 * - It returns a FlatConfigComposer that merges Nuxt's config with custom rules
 * - Plugins are passed as arguments to withNuxt(), NOT spread into an array
 *
...
export default withNuxt(
  ...
  // Oxlint plugin - turns off ESLint rules already covered by oxlint
  // This avoids duplicate checking and improves performance
  ...
  // Ignore patterns - exclude non-source files
  {
    ignores: [
      ...
      // Visual testing
      '.visual-testing/**',
      // Claude Code skills and hooks (standalone utilities)
      '.claude/skills/**',
      '.claude/hooks/**',
    ],
  },
