    ...
    <div ref="scrollContainer" class="container">
      ...
      <div class="flex justify-between items-center mb-6">
        <div class="text-sm text-gray-600 dark:text-gray-400">
          <span v-if="!loading && hasOrders" class="hidden sm:inline">
            {{ $t('orders.showing', { 
          ...
          <span v-if="!loading && hasOrders" class="sm:hidden">
            {{ pagination.total }} {{ $t('orders.orders') }}
          </span>
        </div>
      ...
      <div v-if="loading" class="space-y-4">
        <div v-for="i in 3" :key="i" class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 animate-pulse">
      ...
      <!-- Empty State -->
      <div v-else-if="!hasOrders" class="bg-white dark:bg-gray-800 rounded-lg shadow p-12 text-center">
      ...
      <div v-else>
        ...
        >
          <OrderCard
            ...
            @viewDetails="handleViewDetails(order)"
          />
        </div>
