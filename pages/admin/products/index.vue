  ...
  <div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
      ...
      <div v-else-if="!products?.length" class="p-12 text-center">
        <svg class="h-12 w-12 text-gray-400 dark:text-gray-500 mx-auto mb-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center">
                  <div class="w-10 h-10 bg-gray-200 dark:bg-gray-600 rounded-lg flex-shrink-0 flex items-center justify-center">
                    ...
                    />
                    <svg v-else class="h-6 w-6 text-gray-400 dark:text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const getStockStatusClass = (stock: number) => {
  if (stock > 10) return 'bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200'
