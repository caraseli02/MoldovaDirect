    ...
    <main class="flex-1 flex items-center justify-center px-6 py-8 sm:px-8 lg:px-12">
      <div class="w-full max-w-sm sm:max-w-md space-y-6 sm:space-y-8">
        ...
        <div class="text-center space-y-2">
          ...
          <h1 class="font-[family-name:var(--md-font-serif)] text-2xl sm:text-3xl font-normal text-[var(--md-charcoal)] dark:text-[var(--md-cream)]">
          ...
          >
            ...
            <div class="relative">
              <input
                ...
                class="peer w-full px-4 py-3 border-2 border-[var(--md-gray-200)] dark:border-[var(--md-gray-600)] rounded-xl text-[var(--md-charcoal)] dark:text-[var(--md-cream)] placeholder-transparent focus:border-[var(--md-gold)] dark:focus:border-[var(--md-gold)] focus:outline-none transition-all bg-white dark:bg-[var(--md-charcoal)]"
                placeholder="Email"
              />
              <label
                for="email"
            ...
            <div class="text-center pt-4">
              <NuxtLink
                ...
                class="inline-flex items-center text-sm font-medium text-[var(--md-wine)] hover:text-[var(--md-wine-light)] dark:text-[var(--md-gold)] dark:hover:text-[var(--md-gold-light)] transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--md-gold)]/20 rounded-md px-2 py-1"
...
const handleForgotPassword = async () => {
  ...
  try {
    ...
    error.value = err instanceof Error ? err.message : t('auth.forgotPasswordError')
  }
  finally {
    loading.value = false
  }
