      ...
      <div class="w-full max-w-sm sm:max-w-md space-y-6 sm:space-y-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 sm:p-8">
          <form class="space-y-5" @submit.prevent="handleLogin">
            ...
            <!-- Remember me and forgot password with better mobile layout -->
            <div class="flex items-center justify-between">
              <div class="flex items-center">
                <input
                  ...
                  v-model="rememberMe"
                  type="checkbox"
                  class="w-4 h-4 text-primary-600 bg-white dark:bg-gray-700 border-2 border-gray-300 dark:border-gray-600 rounded focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400"
                >
                <label for="remember" class="ml-2 text-sm text-gray-700 dark:text-gray-300">
                  {{ $t('auth.rememberMe') }}
                </label>
              </div>
              <NuxtLink :to="localePath('/auth/forgot-password')" class="text-sm font-medium text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300 transition-colors">
            ...
            <button
              ...
              class="relative w-full flex justify-center items-center py-3.5 px-4 border-2 border-gray-200 dark:border-gray-600 text-base font-medium rounded-xl text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
            >
