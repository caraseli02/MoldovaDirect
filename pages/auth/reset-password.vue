          ...
          <form v-if="!success" class="space-y-5" @submit.prevent="handleResetPassword">
            ...
            <div class="space-y-4">
              <div class="relative">
                ...
                >
                  <commonIcon v-if="!showPassword" name="lucide:eye" class="h-5 w-5" />
                  <commonIcon v-else name="lucide:eye-off" class="h-5 w-5" />
                </UiButton>
              ...
              <div class="relative">
                ...
                >
                  <commonIcon v-if="!showConfirmPassword" name="lucide:eye" class="h-5 w-5" />
                  <commonIcon v-else name="lucide:eye-off" class="h-5 w-5" />
                </UiButton>
