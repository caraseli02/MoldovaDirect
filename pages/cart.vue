    ...
    <div class="container px-4 md:px-6">
      ...
      <CommonErrorBoundary :fallback-action="() => navigateTo(localePath('/products'))"
        ...
        <div v-else-if="isEmpty" class="text-center py-20" data-testid="empty-cart-message">
          ...
          <h2 class="text-xl md:text-2xl font-semibold text-gray-900 dark:text-white mb-2">{{ $t('products.cartEmpty')
          }}</h2>
        ...
        <div v-else class="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
              <div class="p-4 md:p-6">
                <div class="flex items-center justify-between mb-4">
                  <h2 class="text-lg font-semibold text-gray-900 dark:text-white">{{ $t('common.cart') }} ({{ itemCount
                  }})</h2>
                ...
                <div class="space-y-2 md:space-y-4">
                  ...
                  }" :loading="loading" :data-testid="`cart-item-${item.product.id}`"
                    @update-quantity="safeUpdateQuantity" @remove-item="safeRemoveItem"
                    @swipe-remove="handleSwipeRemove" @save-for-later="handleSaveForLater"
          ...
          <div class="hidden lg:block lg:col-span-1">
            <div
              ...
              <div class="p-6">
                <h2 class="text-lg font-semibold mb-4 text-gray-900 dark:text-white">{{ $t('common.orderSummary') }}
                </h2>
