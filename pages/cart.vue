<template>
  <div class="py-4 md:py-12 pb-32 md:pb-12">
    <div class="container px-4 md:px-6">
      <h1 class="text-2xl md:text-4xl font-bold mb-4 md:mb-8">{{ $t('common.cart') }}</h1>
      ...
      <div v-else-if="isEmpty" class="text-center py-20" data-testid="empty-cart-message">
        ...
        <h2 class="text-xl md:text-2xl font-semibold text-gray-900 mb-2">{{ $t('products.cartEmpty') }}</h2>
        <p class="text-gray-600 mb-6 px-4">{{ $t('products.cartEmptyDescription') }}</p>
        <NuxtLink 
          ...
          <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <div class="p-4 md:p-6">
              <div class="flex items-center justify-between mb-4">
                <h2 class="text-lg font-semibold">{{ $t('common.cart') }} ({{ itemCount }})</h2>
      ...
      <div class="p-4">
        ...
        <div class="mb-3">
          <button 
            ...
            class="w-full flex items-center justify-between text-sm text-gray-600"
          >
