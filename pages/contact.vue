  ...
  <div class="py-12 md:py-20">
    <div class="container">
      <div class="max-w-4xl mx-auto">
        <h1 class="text-4xl font-bold mb-8">{{ $t('common.contact') }}</h1>
          ...
          <div>
            ...
            <div class="space-y-6">
              <div>
                ...
                <p class="text-gray-600">info@moldovadirect.com</p>
                <p class="text-gray-600">support@moldovadirect.com</p>
              </div>
              ...
              <div>
                ...
                <p class="text-gray-600">
                  Moldova Direct S.L.<br>
                  Madrid, Spain
                </p>
              </div>
              
              <div>
                <h3 class="font-semibold text-gray-900 mb-2">Follow Us</h3>
