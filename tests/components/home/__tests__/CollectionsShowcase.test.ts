...
describe.skip('Home CollectionsShowcase', () => {
  const createWrapper = () => {
  ...
  describe.skip('Collection Cards', () => {
    ...
    describe.skip('Reserve Collection Card', () => {
    ...
    describe.skip('Artisan Collection Card', () => {
    ...
    describe.skip('Experience Collection Card', () => {
