...
describe.skip('Home ProductionProcessSection', () => {
  const createWrapper = () => {
  ...
  describe.skip('Production Steps', () => {
    ...
    describe.skip('Step 2: Crushing & Fermentation', () => {
    ...
    describe.skip('Step 5: Quality Selection', () => {
  ...
  describe.skip('Traditions & Sustainability', () => {
