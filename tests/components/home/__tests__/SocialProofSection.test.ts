...
describe.skip('Home SocialProofSection', () => {
  ...
  describe.skip('Testimonials Rendering', () => {
  ...
  describe.skip('Animation Directives', () => {
  ...
  describe.skip('Styling and Layout', () => {
  ...
  describe.skip('Counter Animation Logic', () => {
  ...
  describe.skip('SEO Schema Markup', () => {
  ...
  describe.skip('Swiper Configuration', () => {
