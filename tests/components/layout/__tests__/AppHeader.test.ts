...
describe('Layout AppHeader', () => {
  ...
  it('should show navigation links', () => {
    const wrapper = mountComponent()
    // Check for navigation text content - branch design uses shop, wines, gourmet, about
    const text = wrapper.text()
    expect(text).toContain('common.shop')
  })
  ...
  it('should have fixed header with proper classes', () => {
    ...
    if (header.exists()) {
      ...
      // Branch design uses fixed positioning for luxury header
